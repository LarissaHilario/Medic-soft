        ...
        <label htmlFor="drawer" className="drawer-overlay"></label>
          <div className=' p-4 w-80 h-full peer-checked:translate-x-0'>
            ...
            <ul className='menu font-overpass pt-10'>
                <li className='p-2' ><a className=' text-base font-bold intems-center '> <Icon path={mdiChartBar} size={1} color="#1154FE" /> Dashboard</a></li>
                ...
                <li className='p-2'><a className=' text-base font-bold align-middle items-center'> <Icon path={mdiFileChart} size={1} color="#1154FE" />Informes</a></li>
            </ul>
          </div>
        </div>
      </div>
